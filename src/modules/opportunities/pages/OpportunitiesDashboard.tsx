...
export function OpportunitiesDashboard() {
  ...
  return (
    <div className="container-fluid py-4">
      ...
      <div className="row align-items-center mb-5">
        <div className="col-lg-8">
          <div className="d-flex align-items-center mb-3">
            ...
            <div>
              <h1 className="mb-1 fw-bold" style={{ color: '#0f172a', fontSize: '2.5rem' }}>
                Opportunities
              </h1>
              <p className="text-muted mb-0 fs-5">Manage your sales pipeline and drive revenue growth</p>
            </div>
          </div>
        </div>
      ...
      {error && (
        <div className="alert alert-danger border-0 mb-4" role="alert" style={{ borderRadius: '12px' }}>
          ...
          >
            <div className="card-body p-4">
              <div className="d-flex justify-content-between align-items-start mb-3">
                <div>
                  <h6 className="text-muted text-uppercase small mb-2 fw-bold">Total Leads</h6>
                  <h2 className="mb-0 fw-bold" style={{ color: '#0f172a', fontSize: '2.5rem' }}>{leads.length}</h2>
                </div>
                <div 
        ...
        <div className="col-md-6 col-xl-3">
          ...
          >
            <div className="card-body p-4">
              <div className="d-flex justify-content-between align-items-start mb-3">
                <div>
                  <h6 className="text-muted text-uppercase small mb-2 fw-bold">Active Pipeline</h6>
                  <h2 className="mb-0 fw-bold" style={{ color: '#0f172a', fontSize: '2.5rem' }}>{activeOpportunities.length}</h2>
                </div>
                <div 
                  className="rounded-circle d-flex align-items-center justify-content-center"
                  style={{ 
              ...
              <div className="d-flex align-items-center">
                ...
                <small className="text-muted">{formatCurrency(totalOpportunityValue)} potential</small>
              </div>
            </div>
            <div 
              className="position-absolute bottom-0 start-0 w-100"
        ...
        <div className="col-md-6 col-xl-3">
          ...
          >
            <div className="card-body p-4">
              <div className="d-flex justify-content-between align-items-start mb-3">
                <div>
                  <h6 className="text-muted text-uppercase small mb-2 fw-bold">Won Deals</h6>
                  <h2 className="mb-0 fw-bold" style={{ color: '#0f172a', fontSize: '2.5rem' }}>{wonOpportunities.length}</h2>
                </div>
                <div 
                  className="rounded-circle d-flex align-items-center justify-content-center"
                  style={{ 
              ...
              <div className="d-flex align-items-center">
                ...
                <small className="text-muted">{formatCurrency(totalWonValue)} revenue</small>
              </div>
            </div>
            <div 
              className="position-absolute bottom-0 start-0 w-100"
        ...
        <div className="col-md-6 col-xl-3">
          ...
          >
            <div className="card-body p-4">
              <div className="d-flex justify-content-between align-items-start mb-3">
                <div>
                  <h6 className="text-muted text-uppercase small mb-2 fw-bold">Success Rate</h6>
                  <h2 className="mb-0 fw-bold" style={{ color: '#0f172a', fontSize: '2.5rem' }}>
                    {opportunities.length > 0 ? Math.round((wonOpportunities.length / opportunities.length) * 100) : 0}%
                  </h2>
                </div>
                <div 
                  className="rounded-circle d-flex align-items-center justify-content-center"
          ...
          >
            ...
            >
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h5 className="mb-1 fw-bold" style={{ color: '#0f172a' }}>Quick Actions</h5>
                  <p className="text-muted mb-0 small">Streamline your sales workflow</p>
                </div>
              </div>
            </div>
            <div className="card-body p-4">
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <small className="text-muted">View and qualify leads</small>
                      </div>
                    </div>
                  </Link>
                </div>
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <small className="text-muted">Track opportunity stages</small>
                      </div>
                    </div>
                  </Link>
                </div>
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <small className="text-muted">Manage quotes and approvals</small>
                      </div>
                    </div>
                  </Link>
                </div>
          ...
          >
            ...
            >
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6 className="mb-1 fw-bold" style={{ color: '#0f172a' }}>Recent Activity</h6>
            ...
            <div className="card-body p-4">
              <div className="text-center py-5">
                ...
                <p className="text-muted small mb-0">Activity will appear here when you start working with opportunities</p>
              </div>
            </div>
          </div>
        </div>
