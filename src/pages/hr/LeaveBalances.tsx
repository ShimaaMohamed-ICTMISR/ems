...
export default function LeaveBalances() {
  ...
  const canViewLeaveBalances = canAny([
      ...
      <div className="departments-header">
        <div className="header-content">
          <h1 className="page-title">
            <i className="bi bi-pie-chart me-3"></i>Leave Balances
          </h1>
          <p className="page-subtitle">
            View leave balance breakdown per employee
          </p>
        </div>
      </div>
      ...
      {loading ? (
            ...
            return (
              <div key={i} className="lb-card">
                ...
                <span className="lb-code">
                  {b.leaveType?.code || b.leaveTypeCode || ""}
                </span>
                <div className="lb-remaining">
                  {remaining}{" "}
                  <span className="lb-total">/ {total} days remaining</span>
                </div>
                <div className="lb-bar-bg">
                  <div
                    className={`lb-bar-fill ${getBarClass(used, total)}`}
        ...
        >
          ...
          <p style={{ color: "#95a5a6" }}>
            No leave balance data for this employee in {year}
          </p>
        </div>
      ) : null}
    </div>
