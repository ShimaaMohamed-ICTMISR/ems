...
export default function Employees() {
  ...
  const canViewEmployees = canAny([...HR_PERMISSION_KEYS.EMPLOYEES.VIEW]);
  const canCreateEmployees = canAny([...HR_PERMISSION_KEYS.EMPLOYEES.CREATE]);
  const canEditEmployees = canAny([...HR_PERMISSION_KEYS.EMPLOYEES.EDIT]);
  const canDeleteEmployees = canAny([...HR_PERMISSION_KEYS.EMPLOYEES.DELETE]);
  ...
  useEffect(() => {
    ...
    fetchEmployees();
  }, [page, statusFilter, canViewEmployees]);
  ...
  return (
    <div className="employees-container">
      <div className="employees-header">
        ...
        {canCreateEmployees && (
          <button
            ...
            onClick={() => navigate("/dashboard/hr/employees/create")}
          >
      ...
      {canViewEmployees ? (
                ...
                {filtered.length > 0 ? (
                  filtered.map((emp) => (
                    <tr key={emp.id}>
                      ...
                      <td>
                        {emp.department?.name ||
                          emp.departmentId?.substring(0, 8) + "..."}
                      </td>
                      <td>
                        {emp.position?.title ||
                          emp.positionId?.substring(0, 8) + "..."}
                      </td>
                      <td>
                        ...
                        <div className="action-btns">
                          {canEditEmployees && (
                            <button
                              ...
                              onClick={() =>
                                navigate(
                                  `/dashboard/hr/employees/${emp.id}/edit`,
                                  { state: { employee: emp } },
                                )
                              }
                            >
        ...
        <AccessDeniedState
          title="Employees are restricted"
