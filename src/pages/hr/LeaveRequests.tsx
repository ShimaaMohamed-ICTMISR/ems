...
export default function LeaveRequests() {
  ...
  const canViewLeaveRequests = canAny([
    ...HR_PERMISSION_KEYS.LEAVE_REQUESTS.VIEW,
  ]);
  const canCreateLeaveRequest = canAny([
    ...HR_PERMISSION_KEYS.LEAVE_REQUESTS.CREATE,
  ]);
  const canEditLeaveRequest = canAny([
    ...HR_PERMISSION_KEYS.LEAVE_REQUESTS.EDIT,
  ]);
  const canDeleteLeaveRequest = canAny([
      ...
      <div className="leave-requests-header">
        <div className="header-content">
          <h1 className="page-title">
            <i className="bi bi-envelope-paper me-3"></i>Leave Requests
          </h1>
        ...
        {canCreateLeaveRequest && (
          <button
            ...
            onClick={() => navigate("/dashboard/hr/leave-requests/create")}
          >
                    ...
                    <tr key={r.id}>
                      ...
                      <td>
                        <div className="action-btns">
                          ...
                          {(canDeleteLeaveRequest || canEditLeaveRequest) &&
                            (r.status === "PENDING" ||
                              r.status === "APPROVED") && (
                              <button
